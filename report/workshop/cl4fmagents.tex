...
backprop network with $k$-winner-take-all hidden layers, refractory rotation lifts
interleaved replay above DER++ and isolation again costs nothing on top of it.
\end{abstract}
...
from $89.3$ to $92.7$ in a single pass, above DER++ ($+0.7$ $[+0.3,+1.1]$) and above the
local learner itself, at a static price of $0.5$--$0.9$ points. Isolation on top of rotation
