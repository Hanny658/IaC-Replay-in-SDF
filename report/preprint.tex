...
would otherwise re-inject the isolated update into awake synapses, voiding the guarantees below.
The readout row remains plastic (old classes must stay calibrated).
...
$84.1\pm4.1$). Mask-confined optimiser state is necessary \emph{for Adam}; carrying no state at
all is simpler and better still --- and closer to biology. Third, \emph{soft} rotation (halving,
...
alternation does \citep{driessen2026}.
