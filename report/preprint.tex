...
controller beats it at every depth tested (three seeds).
...
learned skips and the controller), convolution is not, and neither is the skip's effect on
the 100-class thin-signal regime;
