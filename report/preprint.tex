...
unmasked replay reaches $91.5\pm0.3\%$; isolation adds $0.1$--$0.9$ points across replay batch
sizes and the guarantee, $2.6$ without rotation); every reported number is measured on
...
$91.5\pm0.3$ at batch $16$, $90.9\pm0.1$ at $8$ and $88.8\pm0.4$ at $4$: the two factors are
strongly sub-additive, rotation is the larger single factor ($+6.1$ alone, $+3.6$ on top of
isolation), and isolation's marginal accuracy is $0.1$ $[-0.3,+0.5]$ at batch $16$, $0.2$ at
$8$ and $0.9$ at $4$ --- growing as the micro-batch shrinks --- with $0.4$ on the static axis
($94.1$ vs.\ $93.7$). What isolation buys at this configuration is the guarantee that, for the
current input under its suppression mask, replay leaves the hidden activities unchanged ---
exactly on the proven channels, within the margin elsewhere; without it every micro-batch
perturbs the live coalition and the outcome rests on the rotation's tolerance of that
perturbation. The earlier ``$39\times$'' cost of inference-time consolidation was an artefact
...
The full system is flat down to $8$ samples and loses $1.9$ at $4$; rotation with unmasked
replay (dashed) trails it by $0.1$ to $0.9$, more as the batch shrinks; without rotation,
...
where most of the accuracy comes from: with it, even unmasked replay holds $91.5$ at batch $16$ and $88.8$ at batch $4$. Confining
the update to the mask adds $0.1$--$0.9$ points across batch sizes
...
stream is using. Its accuracy value is $2.6$ points without rotation and $0.1$--$0.9$ with it
