...
training data never trained on (Spearman $\rho=0.97$, mean gap $0.9$ points), and those
...
never trained on) as the evaluation set and the remaining nine tenths as the stream, six
...
split, where one of six seeds collapsed --- we report it as unconfirmed.
