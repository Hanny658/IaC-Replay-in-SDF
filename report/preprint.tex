...
while learning the present, as in null-space methods) costs eight points under identical
...
applied unmasked. With everything else identical, mirror isolation reaches only $85.0\pm2.0\%$
...
choice but an eight-point empirical effect ($9.5$ points at the historical $5\%$ fraction).
...
$41.7\pm1.2$ $>$ offline night $35.1\pm0.5$ $\gg$ unmasked $20.2\pm7.5$ $>$ no buffer
$17.3$) and BP+ER reaches $43.6\pm1.1$ at its best learning rate --- the reverse of the
raw-pixel ordering. In our first report (at the historical $5\%$ fraction, local learner at
$37.0$) this read as a $5.6$-point regime boundary; a two-sided fairness pass plus the
sparsity dial revise it to $1.9$ ($41.7\pm1.2$ local vs.\ $43.6\pm1.1$ BP+ER): most of the
...
better of two learning rates): its width \emph{helps} BP+ER ($44.8\pm0.9$ for a dense
$512$--$256$ net), its $30\%$ distance-dependent wiring --- drawn by the same generator on
the same sheets --- costs $1.2$ ($43.6\pm1.0$), and its \kwta{} costs the rest ($40.8\pm0.5$
at the record $10\%$; $39.7\pm0.9$ at the historical $5\%$), leaving backprop-with-replay
\emph{at or below} the local learner on the identical substrate ($41.7\pm1.2$ vs.\
$40.8\pm0.5$ at $10\%$; all cells six seeds except the local one, three). What separates the
...
\subsection{Energy}
Converted to spiking inference ($T_s{=}8$), the default system (always-on rotation, stateless
SGD, record fraction; rate accuracy $94.5\%$ on the measured seed) runs at $93.7\%$ and
$120$\,nJ/sample vs.\ $2461$\,nJ for dense rate inference ($20.6\times$) and $526$\,nJ for
event-driven rate inference ($4.4\times$), improving further with the time budget ($94.2\%$
at $T_s{=}16$, $242$\,nJ). The calibration interaction we reported for the earlier Adam stack
...
mirror direction: protect the past (Section~\ref{sec:direction}) & $85.0\pm2.0$ & $92.5\pm0.3$ \\
...
feature CIFAR-10 & $\mathbf{41.7\pm1.2}$ & $41.9\pm1.2$ & $40.7\pm1.2$ & $\mathbf{43.5\pm0.6}$ & $39.1\pm1.8$ & $43.1\pm1.1$ \\
...
rows); BP+ER keeps a $1.9$-point lead on feature-based CIFAR with both sides at their best
