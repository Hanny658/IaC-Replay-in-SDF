...
assignment. We provide exactness
...
historical $5\%$ family the project inherited, entirely inside the new frontier. No single
configuration wins both axes; always-on rotation is the sequential default.}
\label{fig:frontier}
\end{figure}
