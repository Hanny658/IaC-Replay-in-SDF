...
and mirror-direction isolation (Section~\ref{sec:direction}).
...
regime-adaptivity, not a free lunch.
...
itself); (ii) closing the bout-committed gate's residual static gap ($94.2$ vs.\ $96.0$ rotation-free)
--- e.g.\ an off-minimum completing the flip-flop's hysteresis, or homeostatic bout-length
adaptation;
