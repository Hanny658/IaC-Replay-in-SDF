...
feature regimes, not in the underfit one. The advantage over \emph{other local schedules}
(nights, unmasked ER) remains robust across all three input regimes, and the residual gap to
backpropagation-with-replay on features stands as an honest boundary.
...
learning rates, bounding the regime of our headline comparison; the progress
...
itself); (ii) the bout gate's residual static price ($94.2$ vs.\ $96.0$ rotation-free): the OFF-side
