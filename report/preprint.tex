...
resulting system reaches $91.3\pm0.3\%$ ($92.0\pm0.7\%$ with a stateless optimiser) and no
...
rotation ($92.1/94.2$ vs.\ $92.0/93.4$). The price reverses into a $+2.5$ to $+6.5$ point \emph{gain} on harder data
...
the stateless-SGD variant of Section~\ref{sec:direction} reaches $\mathbf{92.0\pm0.7\%}$.
...
heavy-ball SGD inside the same isolation raises the ceiling: $\mathbf{92.0\pm0.7\%}$ sequential
and $93.4\pm0.2\%$ static (vs.\ $90.8/92.0$ for masked Adam; unmasked SGD control
...
the flip-flop's inactive half in this system (Section~\ref{sec:ablation}).
...
combination not applicable. Bold: column best.}
\label{tab:ablation}
\small
\begin{tabular}{@{}lcc@{}}
\toprule
...
\quad the same gate committed to bouts (min on-duration $2048$) & $\mathbf{92.1\pm0.6}$ & $94.2\pm0.4$ \\
$-$ gate (rotation always on) & $92.0\pm0.7$ & $93.4\pm0.2$ \\
...
($92.0\pm0.7$ vs.\ $84.1\pm4.1$), and replay is worth everything ($19.5$ is the forgetting
floor). The static column identifies who pays: rotation is the only statically costly
component ($93.4$ always-on against $96.0$ for isolation without rotation --- the highest
...
only $63\%$ of the static one. The result, $\mathbf{92.1\pm0.6}$ sequential at $94.2\pm0.4$
static, restores the sequential ceiling and refunds $0.8$ of the static price at once, weakly
dominating always-on rotation ($92.0/93.4$). Bout length is a proper knob: $M{=}512$ (duties
...
itself); (ii) the origin of the bout gate's residual static price ($94.2$ vs.\ $96.0$ rotation-free),
which the OFF-refractory null ties to the rotation of settled coalitions rather than to
trigger frequency --- e.g.\ mastery-annealed rotation depth or utility-weighted benching;
