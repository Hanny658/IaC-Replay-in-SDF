...
that defeat every fixed decay. We provide exactness
...
(iv) convolutional and deeper stacks, for which the per-layer decay controller
(Section~\ref{sec:controller}) supplies the tuning that fixed constants cannot;
